...
{
    public static class MauByAgeStatistics
    {
        public static ExcelPackage AddMauByAgeStatisticsSheet(this ExcelPackage excelPackage, OidzDbContext context)
        {
            Console.WriteLine("MAU by age statistics init");
            ExcelWorksheet worksheet = excelPackage.Workbook.Worksheets.Add("MAU by age statistics");
            ...
            Console.WriteLine("Mau by age statistics added");
